...
class hysds_base {
  ...
  pip { 'bsddb3':
    wheel   => '/etc/puppet/modules/hysds_base/files/bsddb3-6.2.1-cp310-cp310-linux_x86_64.whl',
    ensure  => installed,
    require => [
                Package['dbxml'],
               ],
  ...
  pip { 'dbxml':
    wheel   => '/etc/puppet/modules/hysds_base/files/dbxml-6.1.4-cp310-cp310-linux_x86_64.whl',
    ensure  => installed,
    require => [
                Pip['bsddb3'],
               ],
